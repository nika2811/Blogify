...
public class CommentTests
{
    ...
    [Fact]
    public void Create_EmptyContent_ReturnsFailureResultWithInvalidContentError()
    {
        // Arrange
        ...
        Assert.Equal("Comment.InvalidContent", result.Error.Code);
        Assert.Equal("Comment content cannot be empty.", result.Error.Description);
    }

    [Fact]
    public void Create_NullContent_ReturnsFailureResultWithInvalidContentError()
    {
        // Arrange
        string content = null;
        var authorId = Guid.NewGuid();
